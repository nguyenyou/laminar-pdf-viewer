...
object Bold {
  ...
  implicit open class MutableBuilder[Self <: Bold] (val x: Self) extends AnyVal {
    ...
    inline def setItems(value: js.Array[/*elided*/ Any]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsVarargs(value: (/*elided*/ Any)*): Self = StObject.set(x, "items", js.Array(value*))
