...
object typesSrcDisplayXfaLayerMod {
  ...
  type AnnotationStorage = io.github.nguyenyou.pdfjs.pdfjsDist.typesSrcDisplayAnnotationStorageMod.AnnotationStorage
  ...
  trait XfaLayerParameters extends StObject {
    ...
    var annotationStorage: js.UndefOr[
        io.github.nguyenyou.pdfjs.pdfjsDist.typesSrcDisplayAnnotationStorageMod.AnnotationStorage
      ] = js.undefined
  ...
  object XfaLayerParameters {
    ...
    implicit open class MutableBuilder[Self <: XfaLayerParameters] (val x: Self) extends AnyVal {
      ...
      inline def setAnnotationStorage(value: io.github.nguyenyou.pdfjs.pdfjsDist.typesSrcDisplayAnnotationStorageMod.AnnotationStorage): Self = StObject.set(x, "annotationStorage", value.asInstanceOf[js.Any])
