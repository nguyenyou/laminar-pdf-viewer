...
object typesSrcSharedScriptingUtilsMod {
  ...
  object ColorConverters {
    ...
    inline def CMYK_rgb(param0: js.Tuple4[Any, Any, Any, Any]): js.Array[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("CMYK_rgb")(param0.asInstanceOf[js.Any]).asInstanceOf[js.Array[Double]]
    ...
    inline def RGB_HTML(color: Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("RGB_HTML")(color.asInstanceOf[js.Any]).asInstanceOf[String]
    
    inline def RGB_rgb(color: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("RGB_rgb")(color.asInstanceOf[js.Any]).asInstanceOf[Any]
    
    inline def T_HTML(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("T_HTML")().asInstanceOf[String]
    
    inline def T_rgb(): js.Array[Null] = ^.asInstanceOf[js.Dynamic].applyDynamic("T_rgb")().asInstanceOf[js.Array[Null]]
  }
}
