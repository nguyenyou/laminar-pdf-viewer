...
object typesSrcDisplayEditorDrawersSignaturedrawMod {
  
  @JSImport("pdfjs-dist/types/src/display/editor/drawers/signaturedraw", "SignatureExtractor")
  @js.native
  open class SignatureExtractor () extends StObject
  /* static members */
  object SignatureExtractor {
    ...
    @JSImport("pdfjs-dist/types/src/display/editor/drawers/signaturedraw", "SignatureExtractor.__#30@#PARAMETERS")
    @js.native
    ...
    @JSImport("pdfjs-dist/types/src/display/editor/drawers/signaturedraw", "SignatureExtractor.__#30@#neighborIdToIndex")
    @js.native
