...
import io.github.nguyenyou.pdfjs.pdfjsDist.anon.Background
import io.github.nguyenyou.pdfjs.pdfjsDist.anon.Canvas
import io.github.nguyenyou.pdfjs.pdfjsDist.anon.Img
import io.github.nguyenyou.pdfjs.pdfjsDist.anon.MarkedContentStack
...
object typesSrcDisplayCanvasMod {
  ...
  open class CanvasGraphics protected () extends StObject {
    ...
    def _createMaskCanvas(img: Any): Canvas = js.native
    ...
    def closeEOFillStroke(path: Any): Unit = js.native
    
    def closeFillStroke(path: Any): Unit = js.native
    
    def closePath(): Unit = js.native
    
    def closeStroke(path: Any): Unit = js.native
    
    var commonObjs: Any = js.native
    
    def compose(dirtyBox: Any): Unit = js.native
    
    def composeSMask(ctx: Any, smask: Any, layerCtx: Any, layerBox: Any): Unit = js.native
    
    var compositeCtx: Any = js.native
    
    def constructPath(op: Any, data: Any, minMax: Any): Unit = js.native
    
    def consumePath(path: Any, clipBox: Any): Unit = js.native
    ...
    def endPath(path: Any): Unit = js.native
    ...
    def eoFill(path: Any): Unit = js.native
    
    def eoFillStroke(path: Any): Unit = js.native
    
    def executeOperatorList(operatorList: Any, executionStartIdx: Any, continueCallback: Any, stepper: Any): Any = js.native
    
    def fill(path: Any): Unit = js.native
    def fill(path: Any, consumePath: Boolean): Unit = js.native
    
    def fillStroke(path: Any): Unit = js.native
    
    var filterFactory: Any = js.native
    
    def genericComposeSMask(
      maskCtx: Any,
      layerCtx: Any,
      width: Any,
      height: Any,
    ...
    def paintChar(character: Any, x: Any, y: Any, patternFillTransform: Any, patternStrokeTransform: Any): Unit = js.native
    ...
    def rawFillPath(path: Any): Unit = js.native
    
    var res: Any = js.native
    
    def rescaleAndStroke(path: Any, saveRestore: Any): Unit = js.native
    ...
    def setFillTransparent(): Unit = js.native
    ...
    def setStrokeTransparent(): Unit = js.native
    
    def setTextMatrix(matrix: Any): Unit = js.native
    ...
    def stroke(path: Any): Unit = js.native
    def stroke(path: Any, consumePath: Boolean): Unit = js.native
  ...
  trait CanvasExtraState extends StObject {
    ...
    var activeSMask: Null = js.native
    
    var alphaIsShape: Boolean = js.native
    
    var charSpacing: Double = js.native
    
    var clipBox: js.typedarray.Float32Array = js.native
    ...
    def getPathBoundingBox(): js.typedarray.Float32Array = js.native
    def getPathBoundingBox(pathType: String): js.typedarray.Float32Array = js.native
    ...
    var minMax: js.typedarray.Float32Array = js.native
    
    var patternFill: Boolean = js.native
    
    var patternStroke: Boolean = js.native
