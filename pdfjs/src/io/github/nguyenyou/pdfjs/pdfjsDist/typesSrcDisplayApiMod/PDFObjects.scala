...
import io.github.nguyenyou.pdfjs.std.Generator
...
trait PDFObjects extends StObject {
  ...
  /**
    ...
    * @returns {boolean}
    */
  def delete(objId: String): Boolean = js.native
  ...
  var iterator: js.Function0[Generator[js.Array[Any], Unit, Any]] = js.native
