...
import io.github.nguyenyou.pdfjs.pdfjsDist.anon.Bold
import io.github.nguyenyou.pdfjs.pdfjsDist.anon.Info
import io.github.nguyenyou.pdfjs.pdfjsDist.anon.Intent
import io.github.nguyenyou.pdfjs.pdfjsDist.anon.Length
import io.github.nguyenyou.pdfjs.pdfjsDist.anon.Marked
import io.github.nguyenyou.pdfjs.pdfjsDist.typesSrcDisplayAnnotationStorageMod.AnnotationStorage
import io.github.nguyenyou.pdfjs.pdfjsDist.typesSrcDisplayOptionalContentConfigMod.OptionalContentConfig
...
open class PDFDocumentProxy protected () extends StObject {
  ...
  /**
    ...
    */
  def cachedPageNumber(ref: RefProxy): Double | Null = js.native
  
  /**
    * @type {Object} The canvas factory instance.
    */
  def canvasFactory: js.Object = js.native
  ...
  /**
    ...
    */
  def fingerprints: js.Array[String | Null] = js.native
  ...
  def getOptionalContentConfig(param0: Intent): js.Promise[OptionalContentConfig] = js.native
