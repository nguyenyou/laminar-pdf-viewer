...
object stdStrings {
  ...
  sealed trait default
    extends StObject
       ...
       with WebTransportCongestionControl
  ...
  @js.native
  sealed trait bandwidth
    extends StObject
       with RTCQualityLimitationReason
  inline def bandwidth: bandwidth = "bandwidth".asInstanceOf[bandwidth]
  ...
  @js.native
  sealed trait `low-latency`
    extends StObject
       with WebTransportCongestionControl
  inline def `low-latency`: `low-latency` = "low-latency".asInstanceOf[`low-latency`]
  ...
  sealed trait `maintain-framerate`
    extends StObject
       with RTCDegradationPreference
  inline def `maintain-framerate`: `maintain-framerate` = "maintain-framerate".asInstanceOf[`maintain-framerate`]
  
  @js.native
  sealed trait `maintain-resolution`
    extends StObject
       with RTCDegradationPreference
  inline def `maintain-resolution`: `maintain-resolution` = "maintain-resolution".asInstanceOf[`maintain-resolution`]
  ...
  sealed trait throughput
    extends StObject
       with WebTransportCongestionControl
  inline def throughput: throughput = "throughput".asInstanceOf[throughput]
  ...
  sealed trait `very-low`
    extends StObject
       with RTCPriorityType
  inline def `very-low`: `very-low` = "very-low".asInstanceOf[`very-low`]
