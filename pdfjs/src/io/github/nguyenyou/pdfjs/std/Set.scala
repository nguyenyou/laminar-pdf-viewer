...
trait Set[T] extends StObject {
  ...
  def entries(): SetIterator[js.Tuple2[T, T]] = js.native
  ...
  var iterator: js.Function0[SetIterator[T]] = js.native
  
  /**
    * Despite its name, returns an iterable of the values in the set.
    */
  /* standard es2015.iterable */
  def keys(): SetIterator[T] = js.native
  ...
  /**
    ...
    */
  /* standard es2015.iterable */
  def values(): SetIterator[T] = js.native
}
