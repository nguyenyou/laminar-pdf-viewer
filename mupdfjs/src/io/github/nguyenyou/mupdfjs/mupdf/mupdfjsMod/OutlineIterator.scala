...
@JSImport("mupdf/mupdfjs", "OutlineIterator")
@js.native
open class OutlineIterator ()
  extends io.github.nguyenyou.mupdfjs.mupdf.distMupdfjsMod.OutlineIterator
/* static members */
object OutlineIterator {
  ...
  @JSImport("mupdf/mupdfjs", "OutlineIterator.RESULT_AT_EMPTY")
  @js.native
  val RESULT_AT_EMPTY: /* 1 */ Double = js.native
  
  @JSImport("mupdf/mupdfjs", "OutlineIterator.RESULT_AT_ITEM")
  @js.native
  val RESULT_AT_ITEM: /* 0 */ Double = js.native
  
  @JSImport("mupdf/mupdfjs", "OutlineIterator.RESULT_DID_NOT_MOVE")
  @js.native
