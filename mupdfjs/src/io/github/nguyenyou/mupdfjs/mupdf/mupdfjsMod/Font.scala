...
@JSImport("mupdf/mupdfjs", "Font")
@js.native
open class Font protected ()
  extends io.github.nguyenyou.mupdfjs.mupdf.distMupdfjsMod.Font {
...
object Font {
  ...
  @JSImport("mupdf/mupdfjs", "Font.ADOBE_CNS")
  @js.native
  val ADOBE_CNS: /* 0 */ Double = js.native
  
  @JSImport("mupdf/mupdfjs", "Font.ADOBE_GB")
  @js.native
  val ADOBE_GB: /* 1 */ Double = js.native
  
  @JSImport("mupdf/mupdfjs", "Font.ADOBE_JAPAN")
  @js.native
  val ADOBE_JAPAN: /* 2 */ Double = js.native
  
  @JSImport("mupdf/mupdfjs", "Font.ADOBE_KOREA")
  @js.native
  val ADOBE_KOREA: /* 3 */ Double = js.native
  
  @JSImport("mupdf/mupdfjs", "Font.CJK_ORDERING_BY_LANG")
  @js.native
  val CJK_ORDERING_BY_LANG: RecordFontCJKLanguageFont = js.native
  
  @JSImport("mupdf/mupdfjs", "Font.SIMPLE_ENCODING")
  @js.native
