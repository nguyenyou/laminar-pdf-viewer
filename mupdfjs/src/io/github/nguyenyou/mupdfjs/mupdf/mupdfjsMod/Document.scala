...
@JSImport("mupdf/mupdfjs", "Document")
@js.native
open class Document ()
  extends io.github.nguyenyou.mupdfjs.mupdf.distMupdfjsMod.Document
/* static members */
object Document {
  ...
  @JSImport("mupdf/mupdfjs", "Document.LINK_DEST")
  @js.native
  val LINK_DEST: js.Array[LinkDestType] = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_ENCRYPTION")
  @js.native
  val META_ENCRYPTION: /* "encryption" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_FORMAT")
  @js.native
  val META_FORMAT: /* "format" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_INFO_AUTHOR")
  @js.native
  val META_INFO_AUTHOR: /* "info:Author" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_INFO_CREATIONDATE")
  @js.native
  val META_INFO_CREATIONDATE: /* "info:CreationDate" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_INFO_CREATOR")
  @js.native
  val META_INFO_CREATOR: /* "info:Creator" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_INFO_KEYWORDS")
  @js.native
  val META_INFO_KEYWORDS: /* "info:Keywords" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_INFO_MODIFICATIONDATE")
  @js.native
  val META_INFO_MODIFICATIONDATE: /* "info:ModDate" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_INFO_PRODUCER")
  @js.native
  val META_INFO_PRODUCER: /* "info:Producer" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_INFO_SUBJECT")
  @js.native
  val META_INFO_SUBJECT: /* "info:Subject" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.META_INFO_TITLE")
  @js.native
  val META_INFO_TITLE: /* "info:Title" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "Document.PERMISSION")
  @js.native
