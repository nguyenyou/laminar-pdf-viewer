...
@JSImport("mupdf/mupdfjs", "StructuredText")
@js.native
open class StructuredText ()
  extends io.github.nguyenyou.mupdfjs.mupdf.distMupdfjsMod.StructuredText
/* static members */
object StructuredText {
  ...
  @JSImport("mupdf/mupdfjs", "StructuredText.SELECT_CHARS")
  @js.native
  val SELECT_CHARS: /* "chars" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "StructuredText.SELECT_LINES")
  @js.native
  val SELECT_LINES: /* "lines" */ String = js.native
  
  @JSImport("mupdf/mupdfjs", "StructuredText.SELECT_MODE")
  @js.native
  val SELECT_MODE: js.Array[SelectMode] = js.native
  
  @JSImport("mupdf/mupdfjs", "StructuredText.SELECT_WORDS")
  @js.native
