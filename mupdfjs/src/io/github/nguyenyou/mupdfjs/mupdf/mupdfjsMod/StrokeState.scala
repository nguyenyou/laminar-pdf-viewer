...
@JSImport("mupdf/mupdfjs", "StrokeState")
@js.native
open class StrokeState ()
  extends io.github.nguyenyou.mupdfjs.mupdf.distMupdfjsMod.StrokeState {
...
object StrokeState {
  ...
  @JSImport("mupdf/mupdfjs", "StrokeState.LINE_CAP")
  @js.native
  val LINE_CAP: js.Array[LineCap] = js.native
  
  @JSImport("mupdf/mupdfjs", "StrokeState.LINE_JOIN")
  @js.native
