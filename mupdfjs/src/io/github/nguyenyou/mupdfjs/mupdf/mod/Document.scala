...
@JSImport("mupdf", "Document")
@js.native
open class Document ()
  extends io.github.nguyenyou.mupdfjs.mupdf.distMupdfMod.Document
/* static members */
object Document {
