...
@JSImport("mupdf", "StrokeState")
@js.native
open class StrokeState ()
  extends io.github.nguyenyou.mupdfjs.mupdf.distMupdfMod.StrokeState {
...
object StrokeState {
  ...
  @JSImport("mupdf", "StrokeState.LINE_CAP")
  @js.native
  val LINE_CAP: js.Array[LineCap] = js.native
  
  @JSImport("mupdf", "StrokeState.LINE_JOIN")
  @js.native
