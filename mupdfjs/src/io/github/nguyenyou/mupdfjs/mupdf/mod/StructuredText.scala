...
@JSImport("mupdf", "StructuredText")
@js.native
open class StructuredText ()
  extends io.github.nguyenyou.mupdfjs.mupdf.distMupdfMod.StructuredText
/* static members */
object StructuredText {
  ...
  @JSImport("mupdf", "StructuredText.SELECT_CHARS")
  @js.native
  val SELECT_CHARS: /* "chars" */ String = js.native
  
  @JSImport("mupdf", "StructuredText.SELECT_LINES")
  @js.native
  val SELECT_LINES: /* "lines" */ String = js.native
  
  @JSImport("mupdf", "StructuredText.SELECT_MODE")
  @js.native
  val SELECT_MODE: js.Array[SelectMode] = js.native
  
  @JSImport("mupdf", "StructuredText.SELECT_WORDS")
  @js.native
