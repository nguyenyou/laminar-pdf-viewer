...
/* Rewritten from type alias, can be one of: 
  - `io.github.nguyenyou.comlink`.std.stdStrings.checking
  - `io.github.nguyenyou.comlink`.std.stdStrings.closed
  - `io.github.nguyenyou.comlink`.std.stdStrings.completed
...
object RTCIceConnectionState {
  ...
  inline def checking: io.github.nguyenyou.comlink.std.stdStrings.checking = "checking".asInstanceOf[io.github.nguyenyou.comlink.std.stdStrings.checking]
  ...
  inline def completed: io.github.nguyenyou.comlink.std.stdStrings.completed = "completed".asInstanceOf[io.github.nguyenyou.comlink.std.stdStrings.completed]
